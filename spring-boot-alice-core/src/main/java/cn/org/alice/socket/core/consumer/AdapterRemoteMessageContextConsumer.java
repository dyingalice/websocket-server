...
import cn.org.alice.socket.core.anno.*;
 ...
 */
public class AdapterRemoteMessageContextConsumer extends AdapterContextConsumer<WssRemoteController, String, WssRequestMapping, WssRequestMapping, Pair<String, String>> {
